...
def banner():
    print("""\x1b[0;36m   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 3.0  │  Script By Rian Saputra      │\n       /  ^ \/ / // /  ^ \   │   Github.com/Rian-YNTKTS     │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def menu():
    ...
    print((k+"\n["+p+"1"+k+"]"+p+" Crack ID Dari Public/Teman"))
...
def random_numbers():
  data = []
  print((k+"\n["+p+"•"+k+"]"+p+" Number Harus 5 Digit"))
  print((k+"["+p+"•"+k+"]"+p+" Contoh : 92037"))
  kode=str(input(k+"["+p+"•"+k+"]"+p+" Masukan Number : "))
